...
public class DebugLogSyntaxScheme {
    public static Style[] getStyle() {
        Style[] styles = new Style[39];

        Color comment = new Color(0, 128, 0);
        Color docComment = new Color(128, 10, 13);
        ...
        Color operator = new Color(5, 128, 0);
        ...
        styles[23] = new Style((Color)null, operator);
        styles[24] = new Style((Color)null, docComment);
